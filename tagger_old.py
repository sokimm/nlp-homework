...
HMM_FILE = 'train_task2.hmm'
TEXT_FILE = 'ptb.22.txt'
OUTPUT_FILE = 'ptb.22_pred2.txt'
...
transition = defaultdict(lambda: defaultdict(lambda: defaultdict(lambda: 1.0)))
...
def viterbi(lines):
    ...
    for (index, line) in enumerate(lines):
            ...
            for q in states:
                ...
                for qq in states:         
                    for qqq in states:
                        ...
                        transition_prob = transition[qqq][qq][q]
        ...
        for qq in states:
            for q in states:
                transition_prob = transition[qq][q][FINAL_STATE]
